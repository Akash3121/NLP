...
def read_data() :
    ...
    infile = open("my_customized_dataset.csv","r")
...
def main() :
    ...
    m.add(Bidirectional(LSTM(15, return_sequences=True, activation="relu")))

    m.add(TimeDistributed(Dense(70,activation="relu")))
    ...
    # evaluation
    evaluate_ie(te_sent, te_tag, te_predicted, entity_types,"eval-Task3-Part2.txt")
